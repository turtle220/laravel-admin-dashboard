<template>
    <div id="LinksDashboard" class="Dashboard">
        ...
        <div id="AddSettingsButton">
            <button class="btn btn-success" @click="addForm = !addForm">Toggle Add Donation</button>
        ...
        <transition name="addform">
            <div id="addForm" v-if="addForm">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <DynamicForms :show-details="showDetails" :values="{}" :title="`Add New Donate`" :button="{title:'Add Donate'}" :form="formDetails" @updateItem="update" @save="store"></DynamicForms>
                    </div>
                    <div class="col-md-3" @click="hideAddComponent"></div>
                </div>
        ...
        <transition name="addform">
            <div id="addForm" v-if="editForm">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <DynamicForms :show-details="showDetails" :title="`Edit Donate ${editUser.name}`" :button="{title:'Edit Donate'}" :form="formDetails" @updateItem="update" :values="editUser" @save="update"></DynamicForms>
                    </div>
                    <div class="col-md-3" @click="hideEditComponent"></div>
                </div>
        ...
        return { 
            ...
            columns : [
                ...
                },
                {
                    ...
                    name : 'Facilitator Access Token' , 
                    column : 'facilitatorAccessToken',
                },                {
                    name : 'Payment Status' , 
