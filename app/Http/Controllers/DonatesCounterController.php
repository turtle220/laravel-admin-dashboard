...
class DonatesCounterController extends Controller
{
    // route name
    private $r = 'DonateCounter';
    private $rs = 'DonatesCounter';  
    private $database = 'Trees';  
    ...
    public function index(Request $request)
    {
        ...
        if($search){
            ...
            ->where('trees' , 'LIKE' , '%'.$search.'%')
            ->orWhere('paid_usd' , 'LIKE' , '%'.$search.'%')
            ->orWhere('paid_inr' , 'LIKE' , '%'.$search.'%')
